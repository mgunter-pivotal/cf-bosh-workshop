...
-- Note: this add-route file *may not be correct* for the 10.68.45.0/24 network configured in the Postgres release deployment manifest

-- https://raw.githubusercontent.com/mgunter-pivotal/cf-bosh-workshop/master/bosh-postgres-release/postgres.yml[here]
